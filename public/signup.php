...
<tr> <td>Username</td><td>  <input type="text" class="fieldpadding" name="uname" size=20></td></tr>
...
<tr><td>Consumer Number  </td><td><input type=text name="account" class="fieldpadding" size=20></td></tr>
